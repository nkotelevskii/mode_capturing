...
def plot_digit_samples(samples, args, method=None, epoch=None):
    """
    ...
    if args.problem == 'mixture':
        img_path = './pics/{}/mo3_{}_batches_{}_K_{}_{}_{}.png'.format(args.problem, method, args.num_batches, args.K,
                                                                       args.step_conditioning, args.noise_aggregation)
    else:
        img_path = './pics/{}/epoch_{}_K_{}_{}_{}_{}.png'.format(args.problem, epoch, args.K,
                                                                 args.step_conditioning, args.noise_aggregation,
                                                                 args.use_barker)
